...
'''
    在SVM_Revo1.py的基础上，不单对单一包围像素进行更新分类，
...
# 计算gt全集精度
show_accuracy(pred, pavia_gt_label, 'SVC')  # 90.77 %
...
print('新正确率：', float(new_acc) * 100, '%')  # 新正确率： 96.43 %
print(len(change_list))  # 2421
# print(change_list)

time_end = time.time()
print('total time：', time_end - time_start)  # 12.1s
...
# 存储图片
cv2.imwrite('../imgs/SVM_1800_Revo_1.png', single_merged)
...
# 存储图片
cv2.imwrite('../imgs/SVM_1800_Revo_2.png', single_merged)
